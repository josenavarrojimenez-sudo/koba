...
### 1. TTS with Toño Voice (eleven_multilingual_v2)
Uses the `v1/text-to-speech/{voice_id}` endpoint.

**Config:**
- **Voice ID**: `iwd8AcSi0Je5Quc56ezK` (TOÑO OFICIAL)
- **Model**: `eleven_multilingual_v2`
- **Settings**: Stability 0.5, Similarity Boost 0.75, Style 0.4, Speed 0.9, Speaker Boost enabled.
...
## Pitfalls & Lessons
- **Model Selection**: Always use `eleven_multilingual_v2` for the most natural emotional range.
